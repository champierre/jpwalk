...
describe('Session ID Consistency Fix', () => {
    ...
    test('full session workflow maintains consistent session ID', async () => {
        ...
        const sessionId = 50;
        const locations = [
            { lat: 35.6483737, lng: 139.5585634, timestamp: startTime + 5000, phase: 'fast' },
            { lat: 35.6484000, lng: 139.5586000, timestamp: startTime + 10000, phase: 'fast' },
            { lat: 35.6484500, lng: 139.5586500, timestamp: startTime + 15000, phase: 'slow' }
        ];
    ...
    test('regression test: location data retrieval returns all locations with consistent session ID', async () => {
        ...
        const mockLocations = [
            { id: 100, session_id: sessionId, latitude: 35.6483737, longitude: 139.5585634, timestamp: 1756078210553, phase: 'fast' },
            { id: 101, session_id: sessionId, latitude: 35.6484000, longitude: 139.5586000, timestamp: 1756078213264, phase: 'fast' },
            { id: 102, session_id: sessionId, latitude: 35.6484500, longitude: 139.5586500, timestamp: 1756078216000, phase: 'slow' },
            { id: 103, session_id: sessionId, latitude: 35.6485000, longitude: 139.5587000, timestamp: 1756078219000, phase: 'slow' }
        ];
