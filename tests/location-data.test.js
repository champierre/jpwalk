...
describe('Location Data Management', () => {
    ...
    test('getLocationsBySessionId returns all locations for a session', async () => {
        const sessionId = 30;
        const mockLocations = [
            { id: 15, session_id: 30, latitude: 35.6483737, longitude: 139.5585634, timestamp: 1756077800000, phase: 'fast' },
            { id: 16, session_id: 30, latitude: 35.6484000, longitude: 139.5586000, timestamp: 1756077805000, phase: 'fast' },
            { id: 17, session_id: 30, latitude: 35.6484500, longitude: 139.5586500, timestamp: 1756077810000, phase: 'slow' }
        ];
    ...
    test('displayLocations shows all location records in table format', () => {
        ...
        expect(table.textContent).toContain('35.648374'); // First location latitude
        expect(table.textContent).toContain('35.648450'); // Last location latitude
    });
