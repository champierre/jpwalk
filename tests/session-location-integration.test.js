...
describe('Session Location Integration', () => {
    ...
    test('complete session workflow saves and displays multiple locations', async () => {
        ...
        const mockLocations = [
            { id: 15, session_id: sessionId, latitude: 35.6483737, longitude: 139.5585634, timestamp: 1756077800000, phase: 'fast' },
            { id: 16, session_id: sessionId, latitude: 35.6484000, longitude: 139.5586000, timestamp: 1756077805000, phase: 'fast' },
            { id: 17, session_id: sessionId, latitude: 35.6484200, longitude: 139.5586200, timestamp: 1756077810000, phase: 'fast' },
            { id: 18, session_id: sessionId, latitude: 35.6484400, longitude: 139.5586400, timestamp: 1756077980000, phase: 'slow' },
            { id: 19, session_id: sessionId, latitude: 35.6484600, longitude: 139.5586600, timestamp: 1756077985000, phase: 'slow' },
            { id: 20, session_id: sessionId, latitude: 35.6484800, longitude: 139.5586800, timestamp: 1756077990000, phase: 'slow' }
        ];
    ...
    test('regression test: ensure location data persists with consistent session ID (FIXED)', async () => {
        ...
        const locationsSavedDuringSession = [
            { lat: 35.6483737, lng: 139.5585634, timestamp: 1756077824506, phase: 'fast' },
            { lat: 35.6483737, lng: 139.5585634, timestamp: 1756077829083, phase: 'fast' },
            { lat: 35.6483800, lng: 139.5585700, timestamp: 1756077834000, phase: 'slow' },
            { lat: 35.6484000, lng: 139.5586000, timestamp: 1756077839000, phase: 'slow' }
        ];
        ...
        expect(retrievedLocations[0]).toMatchObject({
            session_id: sessionId,
            latitude: 35.6483737,
            longitude: 139.5585634,
            phase: 'fast'
        });
        expect(retrievedLocations[3]).toMatchObject({
            session_id: sessionId,
            latitude: 35.6484000,
            longitude: 139.5586000,
            phase: 'slow'
        });
