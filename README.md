...
### メイン画面
アプリの開始画面。今週の進捗、達成度グラフ、最近のセッションが表示されます。

![メイン画面](main-screen.png)

### ウォーキングタイマー
インターバル速歩セッション中のタイマー表示。現在のフェーズ（速歩き/ゆっくり歩き）と経過時間が表示されます。

![タイマー画面](timer-screen.png)

### セッション詳細
完了したセッションの詳細画面。ルートマップ、区間データ（時間、フェーズ、距離、速度）を確認できます。

![セッション詳細画面](session-detail-screen.png)

### 全セッション一覧
すべてのウォーキングセッションを時系列で確認できる画面。各セッションをタップして詳細を表示できます。

![全セッション一覧画面](all-sessions-screen.png)
